...
class LaDeDa(nn.Module):
    ...
    def preprocess(self, x, grad_type):
        ...
        elif grad_type == "y_grad":
            kernel = [[-1, -2, -1], [0, 0, 0], [1, 2, 1]]
        elif grad_type == "left_diag":
            kernel = [[0, 1, 2], [-1, 0, 1], [-2, -1, 0]]
        elif grad_type == "right_diag":
        ...
        return F.conv2d(x, grad_kernel, groups=3, padding="same")
...
# ===== FACTORY FUNCTIONS (ĐÃ FIX CÚ PHÁP) =====
